...
func (ts *TokenStorage) SaveToken(ctx context.Context, sessionID string, tokens *TokenResponse) error {
	...
	err := ts.repo.SaveToken(ctx, sessionID, sessionToken)
	if err != nil {
...
func (ts *TokenStorage) GetToken(ctx context.Context, sessionID string) (*TokenResponse, error) {

	sessionToken, err := ts.repo.GetToken(ctx, sessionID)
	if err != nil {
...
func (ts *TokenStorage) ClearTokens(ctx context.Context, sessionID string) error {
	if err := ts.repo.ClearTokens(ctx, sessionID); err != nil {
